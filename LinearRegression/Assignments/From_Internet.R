...
library("ggplot2")  #### Ploting the data
library("gridExtra") #### arrange the grids
library("Hmisc") ### Data Quality and missing data
library("stringr") ### Splitting the Data
library("corrplot") #### Required Correlaction Plot
library("MASS") #### for StepAIC function
library("caret") ### For model buildings
